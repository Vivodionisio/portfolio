...
})({"bD9hk":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c4e9ec0195c0e46b";
...
},{}],"d1BIp":[function(require,module,exports) {
...
function scene() {
    ...
    }, "<60%").from(".hill-2, .stickman-1, .shadow-1, .bag-1, .bag-shadow-1, .stickman-9-blink", {
        x: "100px",
        duration: 1,
        ease: "elastic.out(1, 0.75)"
    }, "<20%").from(".hill-2, .stickman-1, .bag-1", {
        autoAlpha: 0,
        stagger: 0.2
    }, "<").from(".shadow-1, .bag-shadow-1", {
        autoAlpha: 0,
        stagger: 0.2
    }, "<20%").from(".hill-3", {
        autoAlpha: 0,
...
},{"../stickman/master":"kB96Y"}]},["bD9hk","d1BIp"], "d1BIp", "parcelRequire3f98")

//# sourceMappingURL=index.95c0e46b.js.map
